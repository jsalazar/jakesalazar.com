        ...
        <ul id="soedu-primary-nav" class="soedu-primary-nav is-fixed">
            ...
            <li class="has-children">
                ...
                <ul class="soedu-secondary-nav is-hidden">
                    ...
                    <li><a href="http://soe.umich.edu/academics/minor/"><i class="material-icons md-32 align-text-top">school</i> Minor</a></li>
                    <li><a href="http://soe.umich.edu/micromasters/"><i class="material-icons md-32 align-text-top">schedule</i> MicroMasters</a></li>
                    <li><a href="http://soe.umich.edu/academics/courses/"><i class="material-icons md-32 align-text-top">class</i> Courses & Syllabi</a></li>
                    <li><a href="http://soe.umich.edu/academics/non-degree/"><i class="material-icons md-32 align-text-top">local_library</i> Non-Degree</a></li>

                    <!-- <li><a href="http://soe.umich.edu/"><i class="material-icons md-32 align-text-top">collections_bookmark</i> Program Finder</a></li> -->
                </ul>
            </li>
            ...
            <li class="has-children">
                ...
                <ul class="soedu-secondary-nav is-hidden">
                    ...
                    <li><a href="http://soe.umich.edu/research/office/current-awards/"><i class="material-icons md-32 align-text-top">grade</i> Current Awards</a></li>
                    <li><a href="http://soe.umich.edu/research/office/faculty-support/"><i class="material-icons md-32 align-text-top">developer_board</i> Research Proposal Submission</a></li>
                </ul>
            </li>
            <!-- hide on screens wider than md -->
...
<gcse:searchbox-only></gcse:searchbox-only>
    ...
    <script>
        // reset g placeholder value
        window.onload = function() {
            $('#gsc-i-id1').attr("placeholder", "Search SOE");
            // $('input.gsc-input:-ms-input-placeholder').css("font-size","3rem");
        }
    </script>